...
APP_TITLE		:=	CSB3DS
APP_DESCRIPTION	:=	Chaos Strikes Back 3DS
APP_AUTHOR		:=	Darkweb
APP_VER			:= 	0.1
APP_TITLE_ID	:= 
...
CFLAGS	+=	$(INCLUDE) -DARM11 -D_3DS -D_LINUX -DRGB655 -DSDL12 -I/opt/devkitpro/portlibs/3ds/include -I/opt/devkitpro/portlibs/3ds/include/SDL
...
LIBS	:= -lm -lstdc++ -lSDL_image  -lSDL_mixer -lSDL -lcitro2d -lcitro3d -lctru \
