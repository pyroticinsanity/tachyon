...
char szCSBVersion[] = "CSB for 3DS Version " APPVERSION;
int WindowWidth = 400;
int WindowHeight = 320;
int WindowX = 0;
int WindowY = 0;
float st_X = 320.0 / 400.0;
float st_Y = 200.0 / 320.0;
...
int main (int argc, char* argv[])
{
  ...
  folderParentName=(char*)"/3ds/csb/dm";
  folderName=(char*)"/3ds/csb/dm";
  root = (char*)"/3ds/csb/dm";
  ...
  gfxInitDefault();
    ...
    PrintConsole bottom;
   // bottom.bg = C2D_Color32(255, 0, 0, 255);
...
//    ***** Initialize defaults, Video and Audio *****
  if ( SDL_Init ( SDL_INIT_VIDEO | SDL_CONSOLEBOTTOM)<0)//|SDL_INIT_AUDIO|SDL_INIT_TIMER) < 0)
  {
